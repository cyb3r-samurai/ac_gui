...
class TimeCelDistribution
{
public:
    //TimeCelDistribution(const TimeCelDistribution& other);
    TimeCelDistribution() = default;
    ~TimeCelDistribution()= default;
    TimeCelDistribution(const TimeCelDistribution &) = default;
    TimeCelDistribution& operator= (const TimeCelDistribution &) = default;
...
public:
    SegmentPlan() = default;
    SegmentPlan(const SegmentPlan & ) = default;
    ~SegmentPlan() = default;
    ...
    void appendLastCel(std::shared_ptr<Cel> cel);
    int size();
